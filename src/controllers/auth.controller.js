...
export const authController = {
   register: (req, res, next) => {
      return handleRequest(
         ...
         res,
         next,
         `at Controller: Đăng ký thành công`
      );
   },
   ...
   registerAdmin: (req, res, next) => {
      return handleRequest(
         ...
         res,
         next,
         `at Controller: Đăng ký admin thành công`
      );
   },
   ...
   getInfo: (req, res, next) => {
      return handleRequest(
         ...
         res,
         next,
         `at Controller: Lấy thông tin user thành công`
      );
   },
   ...
   refreshToken: (req, res, next) => {
      return handleRequest(
         ...
         res,
         next,
         `at Controller: Refresh token thành công`
      );
   },
};
